...
const components: Components = {
  ...
  h1: ({ children }) => (
    <h1 className="mt-3 mb-2 first:mt-0 text-base font-semibold">{children}</h1>
  ),
  h2: ({ children }) => (
    <h2 className="mt-3 mb-2 first:mt-0 text-sm font-semibold">{children}</h2>
  ),
  h3: ({ children }) => (
    <h3 className="mt-3 mb-1 first:mt-0 text-sm font-medium text-dim">
      {children}
    </h3>
  ),
  ...
  ol: ({ children }) => (
    <ol className="mb-2 last:mb-0 pl-5 list-decimal space-y-1">{children}</ol>
  ),
  ...
  blockquote: ({ children }) => (
    <blockquote className="my-2 border-l-2 border-line pl-3 text-dim italic">
      {children}
    </blockquote>
  ),
  ...
  th: ({ children }) => (
    <th className="border border-line px-2 py-1 text-left font-medium text-dim">
      {children}
    </th>
  ),
  td: ({ children }) => (
