      ...
      <div className="relative z-10 flex h-full flex-col justify-between p-10 xl:p-14">
        <div className="anim-rise" style={{ animationDelay: "60ms" }}>
          ...
          <p className="mt-5 max-w-[34ch] text-[15px] leading-relaxed text-dim">
            Track each role from applied to offer — with an AI co-pilot for the
            email triage and cover letters that drain you.
          </p>
        </div>
              ...
              <div key={s.key} className="flex items-center gap-3">
                <span
                  ...
                  style={{
                    background: s.color,
                    boxShadow: active
                      ? `0 0 0 4px color-mix(in oklab, ${s.color} 18%, transparent)`
                      : "none",
                  }}
                />
        ...
        <div
          className="anim-rise flex items-center gap-6"
      ...
      <main className="relative flex flex-1 items-center justify-center px-5 py-10 sm:px-8">
        ...
        <div className="anim-card relative w-full max-w-[400px]">
            ...
            <div className="flex items-center justify-between border-b border-line px-6 py-4">
              <span className="inline-flex items-center gap-2">
                ...
                <span className="tag text-dim">
                  {isRegister ? "New applicant" : "Returning"}
                </span>
              </span>
              <span className="tag text-faint">
                #JR-{isRegister ? "0001" : "0148"}
              </span>
            </div>
                    ...
                    <div>
                      <div className="mb-1.5 flex items-baseline justify-between">
                        ...
                        {!isRegister && (
                          <a
                            href="#"
                            className="text-xs text-faint transition-colors hover:text-dim"
                          >
                            Forgot?
                          </a>
                        )}
          ...
          <p className="mt-5 text-center text-xs leading-relaxed text-faint">
            ...
            <a
              href="#"
              className="underline-offset-2 hover:text-dim hover:underline"
            >
              Terms
            </a>{" "}
            and{" "}
...
function SuccessState({ isRegister }: { isRegister: boolean }) {
  return (
    <div className="anim-rise py-6 text-center">
      ...
      <p className="mt-1.5 text-sm text-dim">
        {isRegister
          ? "Your first card is on the board. Loading…"
